...
var flowcell_lookuptable = {1: [31, 0], 2: [31, 1], 3: [31, 2], 4: [31, 3], 5: [31, 4], 6: [31, 5], 7: [31, 6], 8: [31, 7],
...
function updatePoreChart (chart, summary, parameter) {
    ...
    for (var i = 0; i < summary.length; i++) {
        ...
        if (parameter == 'read_count') {

            data.push([summary[i][0], summary[i][1], summary[i][2]]);

        } else {

            data.push([summary[i][0], summary[i][1], summary[i][3]]);
...
function requestChannelSummaryData(id) {
    ...
    $.get(url, function (data) {
        ...
        if (data.length > 0) {
            ...
            updatePoreChart(self.chartReadsPerPore, data, 'read_count');
            updatePoreChart(self.chartBasesPerPore, data, 'read_length');

...
def map_the_reads(name_df, task, flowcell, num_matches_targets_barcoded_df, targets, class_per_bar, fastas):
    """
    ...
    if red_reads_df.empty:
        logger.info("Flowcell id: {} - No reads mapped to dangerous areas!"
                    .format(flowcell.id))
        return

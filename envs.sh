...
export MT_DB_NAME='<mysql database name>'
export MT_DB_USER='<mysql database user>>'
export MT_DB_PASS='<mysql database password>'
export MT_DB_PORT='3306'
export MT_DJANGO_DEBUG=false
...
export MT_CENTRIFUGE_INDEX="<Path/to/centrifuge/index/index_name>" # Read centrifuge index from this directory
export MT_LOG_FOLDER='<Path/To/Log/Directory>' # Write Celery log file in this directory
...
export MT_ARTIC_RESULTS_DIR='<Path/To/Artic/Results/Directory>' # Store the Artic results in this directory
